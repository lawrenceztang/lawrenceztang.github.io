...
function display_beating() {
  if(annualized_roi > hold_annualized_roi) {
    document.getElementById("beating").style.color = "green";
    document.getElementById("beating").innerHTML = "You are beating the market!";
  }
  else {
    document.getElementById("beating").style.color = "red";
    document.getElementById("beating").innerHTML = "You are losing to the market!";
  }
}
